                            ...
                            <ul class="chat-box chatContainerScroll">
                                ...
                                <li class="chat-left">
                                    ...
                                    <div class="chat-text">Tudo bem também!
                                        <br>o livro A culpa é das estrelas ainda está disponivel?</div>
                                    <div class="chat-hour">08:57 <span class="fa fa-check-circle"></span></div>
                                </li>
                                <li class="chat-right">
                                    <div class="chat-hour">08:56 <span class="fa fa-check-circle"></span></div>
                                    <div class="chat-text">Está sim.
                                        <br>Ele apenas esta com marcas de uso</div>
                                    <div class="chat-avatar">
                                        <img src="https://www.bootdey.com/img/Content/avatar/avatar5.png" alt="Retail Admin">
                                        <div class="chat-name">Marcos</div>
                                    </div>
                                ...
                                <li class="chat-left">
                                    ...
                                    <div class="chat-text">Está tudo bem!
                                        <br>Moramos na mesma cidade, onde posso te encontrar?</div>
                                    <div class="chat-hour">08:57 <span class="fa fa-check-circle"></span></div>
                                </li>
                                <li class="chat-right">
                                ...
                                <li class="chat-left">
                                    ...
                                    <div class="chat-text">Claro!
                                        <br>hoje te econtro lá então, obrigada!.</div>
