...
<body style="background-image: linear-gradient(to left bottom, #f2eee8, #d4c1a5, #f2eee8);margin-top: 150px;">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-8">
                    <h3 class="box-title mt-5">Inofrmações Gerais</h3>
                    <div class="table-responsive">
                        <table class="table table-striped table-product">
                            <tbody>
                                <tr>
                                    <td width="390">Nome do livro</td>
