	...
	<div class="wrapper">
		...
		<div class="conteudo">
			...
			<div class="input-group input-align">
				...
				<input id="search" name="search" type="text" class="form-control" placeholder="O que procura?" aria-label="Username" aria-describedby="addon-wrapping">
