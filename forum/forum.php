              ...
              <div class="mar-top clearfix">
                <div style="display: flex; flex-direction: row; justify-content: space-between;">
                  <div>
                    ...
                    <select style="width: 100%; font-size: 16.5px; width: 1005px;" id="genero" name="genero">
                    ...
                    <input type="submit" value="Publicar" id="pub" style=" background-color: #ac7e55; color: white; border: none; width: 60px; height: 35px; border-radius: 3px;">
                  </div>
                  <div>
                  </div>
                </div>
